...
```
This package has been built and checked on Travis
[![Build Status](https://travis-ci.org/samthomasRLA/FARS.svg?branch=master)](https://travis-ci.org/samthomasRLA/FARS)
